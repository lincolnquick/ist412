...
Once the server is running, go to http://localhost:8080 in your web browser. Please note that functionality of the application is not complete and the views of the application are still under development.
